...
Don't have an archive yet? Request it from <https://x.com/settings/download_your_data>; X emails a download link in ~24 hours. See [Archive Import → Get an archive](docs/archive.md#get-an-archive).
